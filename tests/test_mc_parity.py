...
CASES = [
    ...
    ("A", "rapid fire D3", kw_mech("RAPID FIRE D3"),
     {"half_range": True}, {}),
    ("A", "blast D3", kw_mech("BLAST D3"), {}, {}),
    ("A", "sustained D3", kw_mech("SUSTAINED HITS D3"), {}, {}),
    ("A", "melta D6", kw_mech("MELTA D6"), {"half_range": True}, {}),
    ("A", "overwatch 6", mech(), {"overwatch": True}, {}),
    ("A", "overwatch 4", mech(),
     {"overwatch": True, "overwatch_value": 4}, {}),
    ("A", "conversion beyond half", kw_mech("CONVERSION",
                                            "SUSTAINED HITS 1"), {}, {}),
    ("A", "conversion within half", kw_mech("CONVERSION",
                                            "SUSTAINED HITS 1"),
     {"half_range": True}, {}),
